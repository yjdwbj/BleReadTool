...
import lcy.gles3d.util.BufferUtils;
import lcy.gles3d.util.LoggerConfig;
import lcy.gles3d.util.ShaderProgram;

public class CubeModel {

    private static final String TAG=CubeModel.class.getName();
    ...
    protected float rotationX  = 1.0f;
    protected float rotationY  = 1.0f;
    protected float rotationZ  = 1.0f;
    protected float scale      = 1.0f;
    protected Matrix4f camera  = new Matrix4f();
    protected Matrix4f projection = new Matrix4f();

    public CubeModel(String name, ShaderProgram shader, float[] vertices, short[] indices) {
        this.name = name;
        this.shader = shader;
...
//        if(rotationX > angle){
//            this.rotationX =  rotationX - angle ;
//        }else if(rotationX < -angle){
//            this.rotationX =  rotationX + angle ;
//        }else{
//            this.rotationX = rotationX;
//        }
...
//        if(rotationY > angle){
//            this.rotationY =  rotationY - angle ;
//        }else if(rotationY < -angle){
//            this.rotationY =  rotationY + angle ;
//        }else{
//            this.rotationY = rotationY;
//        }
...
//        if(rotationZ > angle){
//            this.rotationZ =  rotationZ - angle ;
//        }else if(rotationZ < -angle){
//            this.rotationZ =  rotationZ + angle ;
//        }else{
//            this.rotationZ = rotationZ;
//        }
    ...
    public void setTexture(int textureName) {
        ...
        if(LoggerConfig.ON){
            Log.d(TAG,"get Texture Int is : " + textureName);
        }
    }
